...
summV=zeros(tiles,tiles);

for x1 = -1:(L_length/segments):1
y1=0; %define the location of the charges
...
hold on;
title({'the plot of electric potential distribution of the line charges in the vacuum';'(infinitesimal method) 樊青远11812418'}, 'fontsize',12);
pbaspect([1 1 1]);
...
title({'Isopotential Line of the Line Charge Electric Field in Vacuum (Unit: V)';'(infinitesimal method) 樊青远11812418'}, 'fontsize',12);
pbaspect([1 1 1]);
xlabel('X axis(unit: m)','fontsize',12);% label the x axis
ylabel('Y axis(unit: m)','fontsize',12);% label the y axis
colorbar;
...
title({' Isopotential Line and Power Line of the Line Charge Electric Field in vacuum';...
    'Unit: V';'(infinitesimal method) 樊青远11812418'} , 'fontsize',12);
pbaspect([1 1 1]);
xlabel('X axis(unit: m)','fontsize',12);% label the x axis
ylabel('Y axis(unit: m)','fontsize',12);% label the y axis
colorbar;
...
%% Saving MAT
sumV_infinitesimal = sumV;
save('../var/sumV_infinitesimal.mat','sumV_infinitesimal');
