...
pbaspect([1 1 1]);
axis([-3,3,-3,3,-1000,1000])
xlabel('y/m','fontsize',12),ylabel('z/m','fontsize',12),zlabel('H/m','fontsize',12);
colorbar;
set(gcf,'Position',[10 10 500 500]);
...
ys=3*cos(theta);        %Set the streamline starting circle’s y coordinate
zs=3*sin(theta);         %Set the streamline starting circle’s z coordinate
